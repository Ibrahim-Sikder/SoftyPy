...
const Hero = () => {
    return (
        <div>
            <div className="partners-intro--thumb aos-init aos-animate" style="background-image: url('https://fieldedge.com/wp-content/themes/fieldedge/assets/dist/images/bg/partners-circle.png');">
