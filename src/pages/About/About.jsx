          ...
          <div className="missionRightSide">
            <div>
              ...
              <p className="mt-3 leading-8">
                ...
                open source back end. Our customized web-based solutions include
                Custom Websites, e-commerce portals, Personal or Business
                portfolios, and management solutions. We also build easy-to-use,
                fast, and beautiful native and non-native mobile applications
            ...
            <div className="mt-5">
              ...
              <p className="mt-3 leading-8">
                ...
                unique, creative, trustworthy and easy-to-use software services
                in the IT industry. We have the vision to lead the software
                industry by solving real-life challenges simplistically, and we
                are working relentlessly to execute our plans. We want to go
                above and beyond the expectations of our clients by providing
                the best solutions for them by making them see things
                differently.
              </p>
            </div>
          </div>
      ...
      <div className="team-anim--section">
		...
		c-57.5,16.5-108.8,18.4-150.7,20c-13.2,0.5-41.7,1.2-78-0.7c-29.1-1.5-54.9-4.3-76.7-7.3"
          ...
          <div className="team-anim--sub">
            <h3 className="team-anim--sub-title">Interested in joining us?</h3>
