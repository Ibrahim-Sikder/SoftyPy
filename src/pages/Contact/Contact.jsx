import { FaFacebookF, FaPhoneAlt,FaEnvelope,FaTwitter, FaUsers } from "react-icons/fa";
...
const Contact = () => {
    ...
    return (
        <div>
             <section className='contactUsWrap'>
        <div className='contactss'>
          <div className='contactText'>
            
            <div>
              <div className="md:flex items-center justify-center ">
                {/* <img alt="phone" src={phone} className="mx-auto w-20" /> */}
        ...
        <div className='getInTouchLeft'>
          ...
          <form>
            <div className='formControl'>
                <label> Name </label>
                <input className='inputField' type="text" placeholder="Enter Your Full Name " />
            </div>
            <div className='formControl'>
                <label> Email </label>
            ...
            <div className='formControl'>
                ...
                <input className='inputField' type="text" placeholder="Enter Your Phone Number " />
            </div>
            <div className='formControl'>
                <label> Message </label>
